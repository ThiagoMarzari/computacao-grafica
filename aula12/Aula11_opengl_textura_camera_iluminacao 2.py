...
def main():
    ...
    has_cat = False
    try:
        cat_tex  = load_texture("OBJS/Cat2/Cat2_diffuse.jpg")
        # Carregar objeto
        scene = Wavefront('OBJS/Cat2/Cat2.obj', collect_faces=True, parse=True) # Carrega a geometria do gato
        has_cat = True
    except FileNotFoundError:
        print("\n[AVISO] Os arquivos do modelo 3D 'OBJS/Cat/Cat.obj' e/ou a textura 'Cat_diffuse.jpg' não foram encontrados. Apenas o cubo será exibido.\n")
